...
- The same live activity exposes an independent context defect: `requested_cwd` is correct, but `effective_cwd` is null with `not_dispatched` and repository context absent despite successful execution. This remains uncorrected.
