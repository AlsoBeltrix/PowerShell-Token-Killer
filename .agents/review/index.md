...
| ci-xunit2031-1 | LOW | Output-list regression emits xUnit2031 on every hosted server job | `[~]` | `fix/xunit2031-output-list-guard` (`771522f`) | pending Claude Opus 5 max |
