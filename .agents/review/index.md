...
| ci-worker-cancel-1 | LOW | Windows CI can delay the scheduler's dedicated cancellation thread beyond a test checkpoint | `[~]` | `fix/ci-worker-cancel-checkpoint` (`82c89a1`) | pending Opus review; hosted guard green |
