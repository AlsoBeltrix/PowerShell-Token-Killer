...
| muc-7 | MEDIUM | Ordinary installed upgrade strands active MCP conversations | `[!]` | | `claude/@gcp-vertexai-us-global-integration/anthropic.claude-opus-5/max/frontier` — verdict envelope unavailable |
