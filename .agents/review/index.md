...
| gh-16-1 | HIGH | Caller disconnect can strand a sealed successful invocation artifact | `[~]` | `fix/issue-16-output-discovery` (`6d5dcd2`) | pending `claude/@gcp-vertexai-us-global-integration/anthropic.claude-opus-5/max/frontier` |
