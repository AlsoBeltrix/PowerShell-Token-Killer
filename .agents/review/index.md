...
| gh-14-1 | HIGH | Mixed log output can hand trailing JSON to a lossy whole-stream shaper | `[~]` | `fix/issue-14-json-log-shaping` (`a3a89f8`) | pending Opus review; non-vacuous guard and hosted CI green |
