...
Closed review loops rotated verbatim out of `.agents/review/index.md` on
2026-08-05, when that file reached 303KB and could no longer be read whole
by a cold agent. Nothing here is current state: `.agents/review/index.md`
owns the active loop and `.agents/review/dispositions.md` owns every
`opr-*` disposition. This file is evidence and precedent only.
