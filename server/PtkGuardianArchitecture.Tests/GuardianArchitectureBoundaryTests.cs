...
public sealed class GuardianArchitectureBoundaryTests
{
    ...
    [
        ...
        "PtkMcpServer.Audit.GuardianAuditHostSnapshotSource",
        "PtkMcpServer.Audit.IAuditCallFactory",
        "PtkMcpServer.Audit.IAuditHostSnapshotSource",
    ...
    [
        ...
        "PtkMcpServer.OutputArtifactRenderer",
        "PtkMcpServer.OutputArtifactRenderResult",
        "PtkMcpServer.OutputArtifactSegment",
    ...
    [
        ...
        new("kernel32.dll", "WaitForSingleObject"),
        new("libc", "acl_free"),
    ...
    public void Project_graph_is_exact_one_way_and_resource_closed()
    {
        ...
        AssertPackages(
            ...
            [
                ...
                new("ModelContextProtocol", "1.4.1", null, null),
            ]);
    ...
    public void Native_interop_allowlist_is_exact_guardian_closure()
    {
        AssertExactSet(
            ...
            [
                ...
                new NativeImport("kernel32.dll", "OpenProcess"),
                ...
                new NativeImport("kernel32.dll", "WaitForSingleObject"),
